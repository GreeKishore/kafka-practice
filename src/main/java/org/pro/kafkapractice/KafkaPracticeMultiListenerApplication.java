...
import org.pro.kafkapractice.model.Greeting;
import org.pro.kafkapractice.model.Farewell;

@SpringBootApplication
public class KafkaPracticeMultiListenerApplication {

    public static void main(String[] args) throws Exception {

        ConfigurableApplicationContext context = SpringApplication.run(KafkaPracticeMultiListenerApplication.class, args);
